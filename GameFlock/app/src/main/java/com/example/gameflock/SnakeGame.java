...
public class SnakeGame extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    private int score = 0;
    //maximum size the snake can reach
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AppCompatImageButton topBtn = findViewById(R.id.topButton);
        final AppCompatImageButton bottomBtn = findViewById(R.id.bottomButton);
        final AppCompatImageButton rightBtn = findViewById(R.id.rightButton);
        final AppCompatImageButton leftBtn = findViewById(R.id.leftButton);


        //adding call back to surface view
            ...
            public void run() {
                ...
                if (checkGameOver(headPositionX, headPositionY)){
                    ...
                    builder.setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(SnakeGame.this, SnakeHomeActivity.class);
                    ...
                    for (int i = 1; i< snakePointsList.size(); i++){
                        ...
                        canvas.drawCircle(snakePointsList.get(i).getPositionX(),
                                snakePointsList.get(i).getPositionY(),pointSize, createPointColor());
    ...
    private boolean checkGameOver(int headPositionX, int headPositionY){
        ...
        snakePointsList.get(0).getPositionX() >= surfaceView.getHeight())
